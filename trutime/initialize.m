...
sharedmem.ct = [3,2,3,3,4];                   % controller counts
sharedmem.x0 = {};                            % initial states
sharedmem.h = [2, 2, 2, 2];
sharedmem.Jth = [1, 2, 1, 1];
sharedmem.hset = {};
snsids = {'0x11', '0x21', '0x31', '0x41'};
actids = {'0xa1', '0xc4', '0xd1', '0xf4'};
...
%     [lqg, K, Obs, ~, L, pd] = lqgdesign(sc,Qsc,QN_sc,RN_sc,h_sc{i})
    ...
    [lq, gains] = lqg(Pd,sharedmem.Q{5},sharedmem.R{5});
    sharedmem.Pd5{i} =  Pd;
